 ...
 * @author FeedzOne
 */
public class FrmBuscarLibroEditar extends javax.swing.JFrame {

    /**
     * Creates new form FrmBuscarLibroEditar
     */
    public FrmBuscarLibroEditar() {
        initComponents();
        showSearch("");
    }
    ...
    private void TblLibrosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TblLibrosMousePressed
        ...
        if(evt.getClickCount() == 2){
            String id = TblLibros.getValueAt(TblLibros.getSelectedRow(), 0).toString();
            String name = TblLibros.getValueAt(TblLibros.getSelectedRow(), 1).toString();
            FrmEditarPrestamos.setLibro(id,name);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscarLibroEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuscarLibroEditar().setVisible(true);
            }
        });
    }
